...
import org.mailfilter.ui.core.UICaptcha;
import org.mailfilter.ui.core.UIDateInput;
import org.mailfilter.ui.core.UIFormRichtextInput;
import org.mailfilter.ui.core.UISearchInput;
...
public class UILessonForm extends UIForm implements UIPopupComponent{
	...
	static  public class SaveActionListener extends EventListener<UILessonForm> {
		...
		public void execute(Event<UILessonForm> event) throws Exception {
			...
			MailfilterPortlet.getDataService().saveSession(es, true);
			MailfilterPortlet calendarPortlet = uiForm.getAncestorOfType(MailfilterPortlet.class) ;
			calendarPortlet.closePopup();
			event.getRequestContext().addUIComponentToUpdateByAjax(
			uiForm.getAncestorOfType(MailfilterPortlet.class).findFirstComponentOfType(UILessonList.class));
