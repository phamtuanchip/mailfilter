...
@ComponentConfig(
		template =  "app:/templates/mailfilter/webui/UIResourceViewer.gtmpl",
		events = {
...
public class UIResourceViewer extends UIContainer {
	...
	public String getResourceUrl(Attachment att, String type, int w, int h) {
		...
		return "/" + PortalContainer.getInstance().getRestContextName() +  "/mailfilter/api/media/" + id +"?type="+type+"&w="+w+"&h="+h;
	}
